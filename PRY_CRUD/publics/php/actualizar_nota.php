...
// Recalcular el promedio en el servidor para mayor seguridad
$promedio = ($n1 + $n2 + $n3) / 3;
...
try {
    if ($stmt->execute()) {
        // Obtener nombres para la notificación y la respuesta
        ...
        // Devolver datos para actualizar la tabla dinámicamente
        $responseData = [
            'idN' => $idN,
